          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-gray-50/50 dark:bg-gray-800/40 border-b border-gray-100 dark:border-gray-800">
                <th className="px-4 py-5 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] whitespace-nowrap">Member Profile</th>
                <th className="px-4 py-5 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] text-center whitespace-nowrap">Designation</th>
                <th className="px-4 py-5 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] whitespace-nowrap">Client Attachment</th>
                <th className="px-4 py-5 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] whitespace-nowrap">Onboarding</th>
                <th className="px-4 py-5 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] text-right whitespace-nowrap">Actions</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-50 dark:divide-gray-800">
              {loading ? (
                <tr><td colSpan="5" className="px-4 py-12 text-center text-gray-400 text-sm animate-pulse">Synchronizing team data...</td></tr>
                ...
                <tr key={user._id} className="hover:bg-gray-50/50 dark:hover:bg-gray-700/20 transition-all group">
                  ...
                  <td className="px-4 py-5 text-[11px] font-black text-gray-500 dark:text-gray-400 font-mono whitespace-nowrap">
